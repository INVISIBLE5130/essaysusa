...
const handleServicesClick = () => {
  services.classList.toggle('paper_active');
  servicesLink.classList.toggle('paper-link_active');
...
servicesLink.addEventListener('click', handleServicesClick);
servicesLinkMobile.addEventListener('click', handleServicesClick);
